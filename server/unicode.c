...
{
    static const char *nls_dirs[] = { NULL, DATADIR "/wine/nls", "/data/data/com.winlator/files/rootfs/usr/usr/local/share/wine/nls", "i/data/data/com.winlator/files/rootfs/usr/usr/share/wine/nls" };
